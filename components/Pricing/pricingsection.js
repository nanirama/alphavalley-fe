                    ...
                    <div className="container">
                        ...
                        <div className="button-group">
                            <div className="buttons">
                                <div className="btn-box"><button className="is-active">Monthly billing</button><button className="false">Annual billing</button></div>
                            </div>
                        </div>
                    </div>
                </div>
                            ...
                            <div className="col-lg-3 col-md-12 col-sm-12 col-12 dummy">
                                <div className="top">
                                    <div className="price-box">
                                        ...
                                        <div className="buy-button"><button className="btn">Get started</button><button className="btn">Chat to sales</button></div>
                                    </div>
                                </div>
                            ...
                            <div className="col-lg-3 col-md-12 col-sm-12 col-12 valid">
                                <div className="top">
                                    <div className="price-box">
                                        ...
                                        <div className="buy-button"><button className="btn blue">Get started</button><button className="btn chat">Chat to sales</button></div>
                                    </div>
                                </div>
                                <div className="bottom">
                                    <div className="p-box">
                                ...
                                <div className="buy-button"><button className="btn blue">Get started</button><button className="btn">Chat to sales</button></div>
                            </div>
                            <div className="col-lg-3 col-md-12 col-sm-12 col-12 valid">
                                <div className="top">
                                    <div className="price-box">
